...
| LCMAP Forest Depth | Hangkai et al. (in prep.) | 30m Albers | `LCMAP_CU_{year}_V13_LCPRI.tif`; values 1–5 (5=interior); derived from USGS LCMAP |
...
Hangkai, Y., et al. (in preparation). Human-induced disturbances accelerate forest edge expansion in the U.S.
